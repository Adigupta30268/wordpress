...
<form id="wpo_importer" action="<?php echo admin_url('admin-ajax.php') ?>" method="post">

	<input type="hidden" name="action" value="launch_ocr" />

	<input type="hidden" name="_ajax_nonce" value="<?php echo wp_create_nonce( "import_wpo" ); ?>" />
	...
	<div class="file_by_file">
		...
		<button class="add"><img src="<?php echo plugins_url('images/add.png', dirname(__FILE__)) ?>" /> Add a file</button>
		<input type="submit" value="Launch OCR !" />
	</div>	

	<div class="progress">
		<img src="<?php echo plugins_url('images/progress_bar.gif', dirname(__FILE__)) ?>" />
...
<div>
	<h3>Need more options ? Look at full version of <a href="https://www.info-d-74.com/en/produit/wp-power-ocr-plugin-wordpress-2/" target="_blank">WP Power OCR</a>! <a href="https://www.facebook.com/infod74/" target="_blank"><img src="<?php echo plugins_url( 'images/fb.png', dirname(__FILE__)) ?>" alt="" /></a></h3>
	<a href="http://www.info-d-74.com/produit/wp-power-ocr-plugin-wordpress/" target="_blank"><img src="<?php echo plugins_url('images/pro.png', dirname(__FILE__)) ?>" /></a>
</div>