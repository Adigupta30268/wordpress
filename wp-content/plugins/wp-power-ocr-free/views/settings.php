...
<form method="post" id="wpo_settings" action="<?php echo admin_url('admin.php?page=wp_power_ocr_settings') ?>">
	...
	<input type="text" name="licence_code" value="<?php echo $licence_code ?>" />
	<br />
...
<?php
	...
	if(!empty($username) && !empty($licence_code))
		echo '<div id="start_wpo">Settings ok. <a href="'.admin_url('admin.php?page=wp_power_ocr').'">Click here to start using WP Power OCR</a>';
